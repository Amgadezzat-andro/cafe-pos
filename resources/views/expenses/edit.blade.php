            ...
            <div class="bg-white rounded-lg shadow p-6">
                <form action="{{ route('expenses.update', $expense) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="expense_date" id="expense_date" value="{{ old('expense_date', $expense->expense_date->toDateString()) }}" required
                    ...
                    <div>
                        ...
                        <textarea name="notes" id="notes" rows="4"
                                  ...
                                  placeholder="Additional details about this expense">{{ old('notes', $expense->notes) }}</textarea>
                        @error('notes')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
