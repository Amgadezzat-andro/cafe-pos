                ...
                <form action="{{ route('purchases.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            ...
                            <input type="number" name="purchase_price" id="purchase_price" value="{{ old('purchase_price') }}" required 
                                   step="0.01" min="0.01"
                    ...
                    <div>
                        ...
                        <input type="date" name="purchase_date" id="purchase_date" value="{{ old('purchase_date', now()->toDateString()) }}" required
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded p-4">
                        <p class="text-sm text-blue-800">
                            <strong>Note:</strong> When you create this purchase, the inventory for the selected product will automatically be increased by the quantity specified.
                        </p>
                    </div>
